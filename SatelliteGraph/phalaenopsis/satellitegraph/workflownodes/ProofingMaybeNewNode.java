...
public class ProofingMaybeNewNode extends WorkflowNode {
	protected void Next(NodeFlowContext flowContext) {
		HttpServletRequest request = ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes())
				.getRequest();

		MapSpot2016 mapSpot216 = (MapSpot2016) request.getAttribute("MapSpotData");
		if (mapSpot216 != null) {
			SatelliteGraphDao satelliteGraphDao = ManualAssembly.getAssembly("satelliteGraphDao");
			satelliteGraphDao.saveMapSpot2016(mapSpot216);
		}
	}
}