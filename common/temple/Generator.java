...
//		System.out.print("输入");
		String s=JOptionPane.showInputDialog("请输入你要操作的表:");
		strategy.setInclude(new String[] { s }); // 需要生成的表
		...
		tc.setEntity("temple/entity.java.vm");
		tc.setMapper("temple/mapper.java.vm");
		tc.setXml("temple/mapper.xml.vm");
		tc.setService("temple/service.java.vm");
		tc.setController("temple/controller.java.vm");
		mpg.setTemplate(tc);
		// 执行生成
		mpg.execute();
	}
